...
public class EdgeGestureSearchIndexablesProvider extends SearchIndexablesProvider {
    private static final String TAG = "EdgeGestureSearchIndexablesProvider";

    public static final int SEARCH_IDX_BUTTON_PANEL = 0;

    private static SearchIndexableResource[] INDEXABLE_RES = new SearchIndexableResource[] {
            new SearchIndexableResource(1, R.xml.button_panel, ButtonSettingsActivity.class.getName(),
